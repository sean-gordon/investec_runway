                    ...
                    <tr>
                        ...
                        <td class='content'>
                            ...
                            <table class='stats-table'>
                                ...
                                <tr><td>Spend This Month</td><td style='text-align: right;' class='amount'>{healthReport.SpendThisMonth.ToString("C", culture)}</td></tr>

                                <tr><td>Spend Last Month</td><td style='text-align: right;' class='amount'>{healthReport.SpendLastMonth.ToString("C", culture)}</td></tr>

                                <tr><td>Projected Month End</td><td style='text-align: right;' class='amount highlight-warn'>{healthReport.ProjectedMonthEndSpend.ToString("C", culture)}</td></tr>
